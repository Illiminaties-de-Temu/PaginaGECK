...
export const PROJECTS_STATIC = [
  { id: 1,  cat: 'landing',  title: 'Chuchulucos',          tech: ['Astro', 'Tailwind CSS', 'Framer Motion'],                           link: 'https://chuchulucos.geckcodex.com/',        gradient: 'linear-gradient(145deg, #3b0764 0%, #6d28d9 40%, #db2777 100%)', image: '/assets/image/portafolio/chuchu.webp', cardImage: '/assets/image/portafolio/chuchulucos.webp', cardFit: 'contain', cardBg: '#141414',
  ...
  { id: 3,  cat: 'landing',  title: 'LandingKit',            tech: ['Astro', 'React', 'Tailwind CSS'],                                   link: 'https://landig-plantilla.geckcodex.com/',   gradient: 'linear-gradient(145deg, #2e1065 0%, #7c3aed 45%, #c026d3 100%)', image: '/assets/image/portafolio/landig.webp', cardImage: '/assets/image/portafolio/landig-kit.webp', cardFit: 'contain', cardBg: '#F4F3F0',
  ...
  { id: 18, cat: 'webapp',   title: 'Tablá',                  tech: ['Astro', 'React', 'Tailwind CSS'],                                                                                    gradient: 'linear-gradient(145deg, #1e1e1c 0%, #222220 40%, #D4AF37 100%)', image: '/assets/image/portafolio/tabla.webp', cardFit: 'contain', cardBg: 'linear-gradient(145deg, #1e1e1c 0%, #222220 40%, #D4AF37 100%)', link: 'https://laschikis.vercel.app/?tema=fonda' },
  ...
  { id: 23, cat: 'landing',  title: 'Plantilla Inmobiliaria', tech: ['Astro', 'React', 'Tailwind CSS'],                                                                                    gradient: 'linear-gradient(145deg, #0c1e3c 0%, #0B1D33 45%, #B8941F 100%)', image: '/assets/image/portafolio/inmovil.webp', cardImage: '/assets/image/portafolio/inmo-plantillas.webp', link: 'https://inmobil.netlify.app/', cardFit: 'contain', cardBg: '#F4F3F0',
  ...
  { id: 25, cat: 'webapp',   title: 'Mi Caja Restaurante',   tech: ['React', 'Node.js', 'PostgreSQL', 'Flutter'],                                                                          gradient: 'linear-gradient(145deg, #0c1e3c 0%, #14532d 45%, #0B1D33 100%)', image: '/assets/image/portafolio/micaja-res.webp', cardFit: 'contain', cardBg: '#F1F0EA',
