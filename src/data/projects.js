...
export const PROJECTS_STATIC = [
  ...
  { id: 3,  cat: 'landing',  title: 'LandingKit',            tech: ['Astro', 'React', 'Tailwind CSS'],                                   link: 'https://landig-plantilla.geckcodex.com/',   gradient: 'linear-gradient(145deg, #2e1065 0%, #7c3aed 45%, #c026d3 100%)', image: '/assets/image/portafolio/landig.webp', cardFit: 'contain', cardBg: '#000000',
  ...
  { id: 18, cat: 'webapp',   title: 'Tablá',                  tech: ['Astro', 'React', 'Tailwind CSS'],                                                                                    gradient: 'linear-gradient(145deg, #1e1e1c 0%, #222220 40%, #D4AF37 100%)', image: '/assets/image/portafolio/tabla.webp', cardFit: 'contain', cardBg: '#000000', link: 'https://laschikis.vercel.app/?tema=fonda' },
